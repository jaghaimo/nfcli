...
- __Application__ refers to LT Hazel bot, the software program provided by the Company.
...
Usage Data includes your Discord user id (globally unique numerical value), type of conversion requested (e.g. fleet, ship or missile conversion), Discord server where the request occurred, and full date of the request.
...
Our Service may contain links to other websites that are not operated by Us (e.g. Steam Workshop). If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.
